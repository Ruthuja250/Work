...
@Component({
  ...
  templateUrl: './upper-lid.component.html',
  styleUrls: ['./upper-lid.component.css']
})
export class UpperLidComponent implements OnInit {
  ...
  private initScene() {
   ...
   light2.position.set(0,300,-500);
    ...
    private loadModel() {
      ...
      loader.load('assets/UpperLid2.glb', (glb) => {
